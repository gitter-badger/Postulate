...
namespace Postulate.SqlServer.GuidKey
{
	public static class ConnectionExtensions
	{
		...
		public static bool Exists<TModel>(this IDbConnection connection, Guid id, IUser user = null, string tableName = null)
		{
			return GetProvider().Exists<TModel>(connection, id, user, tableName);
		}

		public async static Task<bool> ExistsAsync<TModel>(this IDbConnection connection, Guid id, IUser user = null, string tableName = null)
		{
		...
		public static TModel Find<TModel>(this IDbConnection connection, Guid id, IUser user = null, string tableName = null)
		{
			return GetProvider().Find<TModel>(connection, id, user, tableName);
		}

		public async static Task<TModel> FindAsync<TModel>(this IDbConnection connection, Guid id, IUser user = null, string tableName = null)
		{
		...
		public static Guid Merge<TModel>(this IDbConnection connection, TModel @object, IUser user = null, string tableName = null)
		{
			return GetProvider().Merge(connection, @object, user, tableName);
		}

		public async static Task<Guid> MergeAsync<TModel>(this IDbConnection connection, TModel @object, IUser user = null, string tableName = null)
		{
			return await GetProvider().MergeAsync(connection, @object, user, tableName);
		}

		public static Guid Save<TModel>(this IDbConnection connection, TModel @object, IUser user = null, string tableName = null)
		{
		...
		public async static Task<Guid> InsertAsync<TModel>(this IDbConnection connection, TModel @object, IUser user = null, string tableName = null)
		{
		...
		public static void Delete<TModel>(this IDbConnection connection, Guid id, IUser user = null, string tableName = null)
		{
			GetProvider().Delete<TModel>(connection, id, user, tableName);
		}

		public async static Task DeleteAsync<TModel>(this IDbConnection connection, Guid id, IUser user = null, string tableName = null)
		{
